...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("delete from accepted where nid = ?");
         pst.setString(1, id);
        pst.executeUpdate();  
          
          String sql ="insert into denied(fname,mname,lname,nid,height,email,college,school,department,year)values('"+fname+"','"+mname+"','"+lname+"','"+nid+"','"+height+"','"+email+"','"+college+"','"+school+"','"+department+"','"+year+"')";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Confirm Denial</h2>
                      ...
                      <%    
                        ...
                        pst = con.prepareStatement("select * from accepted where nid = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="submit" id="signup" class="form-submit" value="Confirm Denial"/>
                            </div>
                        </form>
