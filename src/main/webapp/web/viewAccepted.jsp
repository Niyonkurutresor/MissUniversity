...
%>
<h2 align="center"><font><strong>Miss University - Accepted Applicants</strong></font></h2>
...
<td><a href="denyaccepts.jsp?id=<%=resultSet.getString("nid") %>"><button type="button" class="delete">Deny</button></a> </a> </td> 
